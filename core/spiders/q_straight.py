                ...
                for table in tables:
                    ...
                    for i, row in enumerate(table, start=1):
                        ...
                        if len(row) == 13:
                            ...
                            item["section_350_meters_to_rail_for_section"] = row[10].split('\n')[2].split('(')[1][:-1],
