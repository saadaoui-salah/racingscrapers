                ...
                for table in tables:
                    ...
                    for i, row in enumerate(table, start=1):
                        ...
                        if len(row) == 13:
                            ...
                            item["section_7_avg_m_to_rail"] = row[10].split('\n')[2].split('(')[1][:-1],
